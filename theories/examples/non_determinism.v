...
Section handlee_examples.
  ...
  Proof.
    ...
    iApply (bewp_introduction' [ndet] [ndet] (ND ndet)).
    ...
    iApply (bewp_introduction' [ndet] [ndet] (ND ndet)); last auto.
    { by apply elem_of_cons; left. }
  ...
  Proof.
    ...
    by iSplit; [|iSplit]; iModIntro; iApply bewp_value;
    do 2 bewp_pure_l; do 2 bewp_pure_r;
    iApply ex1.
  Qed.
...
Section ndet_run_pure_correctness.
  ...
  Lemma ndet_run_pure_correct ndet e1 e2 L :
    BEWP e1 ≤ e2 <|([ndet], [ndet], ND ndet) :: L|> {{same_result}} -∗
    BEWP ndet_run_pure ndet e1 ≤
  ...
  Proof.
    ...
    iApply (bewp_exhaustion with "Hbewp"). { by simpl. } { by simpl. }
    iSplit.
    ...
    - iIntros "!> %%%%% %Hk1' %Hk2' HND #Hk".
      ...
      + iDestruct "HND" as "[%e11 [%e12 [%e21 [%e22 HND]]]]".
        ...
        do 2 bewp_pures_l.
        do 2 bewp_pures_r.
        iApply (bewp_bind' [_;_] [_;_]).
        { iApply traversable_to_iThy; intros ?; constructor; set_solver. }
        iApply bewp_wand.
        { iApply "IH". by iApply "Hk". }
        iIntros "!> %% [%xs [-> ->]]".
        iApply bewp_list_concat_l. iNext.
        iApply bewp_list_concat_r.
        iApply bewp_value.
        by iExists (xs ++ ys).
      ...
      + iDestruct "HND" as "[%e11 [%e12 [%e13 [%e21 [%e22 [%e23 HND]]]]]]".
        ...
        do 5 bewp_pures_l.
        { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
        bewp_pures_r. bewp_pures_l.
        iApply (bewp_bind' [_; _] [_]).
        { iApply traversable_to_iThy; intros ?; constructor; set_solver. }
        iApply bewp_wand.
        { iApply "IH". by iApply "Hk". }
        iIntros "!> % % [%zs [-> ->]]".
        do 2 bewp_pures_l. do 6 bewp_pures_r.
        { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
        bewp_pures_r.
        iApply (bewp_bind' [_;_;_] [_;_;_]).
        { iApply traversable_to_iThy; intros ?; constructor; set_solver. }
        iApply bewp_wand.
        { iApply "IH". by iApply "Hk". }
        iIntros "!> % % [%ys [-> ->]]".
        iApply (bewp_list_concat_l). iNext.
        do 2 bewp_pures_l. do 2 bewp_pures_r.
        iApply (bewp_bind' [_;_] [_;_;_;_]).
        { iApply traversable_to_iThy; intros ?; constructor; set_solver. }
        iApply bewp_wand.
        { iApply "IH". by iApply "Hk". }
      ...
      + iDestruct "HND" as "[%e11 [%e12 [%e13 [%e21 [%e22 [%e23 HND]]]]]]".
        ...
        { iApply "IH". by iApply "Hk". }
        iIntros "!> % % [%zs [-> ->]]".
        do 2 bewp_pures_r. do 6 bewp_pures_l.
        { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
        bewp_pures_l.
        iApply (bewp_bind' [_;_;_] [_;_;_]).
        { iApply traversable_to_iThy; intros ?; constructor; set_solver. }
      ...
      + iDestruct "HND" as "[%e11 [-> #HQ]]".
        ...
        { iApply "IH". by iApply "Hk". }
        iIntros "!> %% [%xs [-> ->]]".
        do 2 bewp_pures_l. { by apply neutral_ectx; set_solver. }
        iApply (bewp_list_concat_l _ []). iNext.
        iApply bewp_value.
        by iExists xs.
      ...
      + iDestruct "HND" as "[%e11 [-> #HQ]]".
        ...
        { iApply "IH". by iApply "Hk". }
        iIntros "!> %% [%xs [-> ->]]".
        iApply (bewp_list_concat_l _ xs []). iNext.
        rewrite app_nil_r.
        iApply bewp_value.
        by iExists xs.
      ...
      + iDestruct "HND" as "[%e22 (Hlc & -> & #HQ)]".
        ...
        { iApply "IH". by iApply "Hk". }
        iIntros "!> %% [%xs [-> ->]]".
        do 2 bewp_pures_r. { by apply neutral_ectx; set_solver. }
        iApply (bewp_list_concat_r _ []).
        iApply bewp_value.
        by iExists xs.
      ...
      + iDestruct "HND" as "[%e22 (Hlc & -> & #HQ)]".
        ...
        { iApply "IH". by iApply "Hk". }
        iIntros "!> %% [%xs [-> ->]]".
        iApply (bewp_list_concat_r _ xs []).
        rewrite app_nil_r.
        iApply bewp_value.
        by iExists xs.
  Qed.
...
Section ndet_run_rand_correctness.
  ...
  Lemma ndet_run_rand_correct ndet e1 e2 L :
    BEWP e1 ≤ e2 <|([ndet], [ndet], ND_ext ndet) :: L|> {{same_result}} -∗
    BEWP ndet_run_rand ndet e1 ≤
  ...
  Proof.
    ...
    iApply (bewp_exhaustion with "Hbewp"). { by simpl. } { by simpl. }
    iSplit.
    - iIntros "!> %%->". bewp_pures_l. by bewp_pures_r.
    - iIntros "!> %%%%% %Hk1' %Hk2' HND #Hk".
      ...
      + iDestruct "HND" as "[%e11 [%e12 [%e21 [%e22 HND]]]]".
        ...
        do 5 bewp_pures_l.
        { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
        iApply bewp_rand_l. iIntros (b).
        do 5 bewp_pures_r.
        { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
        iApply (bewp_rand_r b).
        destruct b.
        * do 2 bewp_pures_l. do 2 bewp_pures_r. iApply "IH". by iApply "Hk".
        * do 2 bewp_pures_l. do 2 bewp_pures_r. iApply "IH". by iApply "Hk".
      ...
      + iDestruct "HND" as "[-> ->]".
        ...
        { apply neutral_ectx; set_solver. }
        do 8 bewp_pure_l.
        iLöb as "IH'". bewp_pure_l. by iApply "IH'".
      ...
      + iDestruct "HND" as "[%e11 [%e12 [%e13 [%e21 [%e22 [%e23 HND]]]]]]".
        ...
        do 5 bewp_pures_r.
        { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
        iApply bewp_rand_l. iIntros (b). destruct b.
        * bewp_pures_l. bewp_pures_l. iApply (bewp_rand_r true).
          do 6 bewp_pures_r.
          { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
          iApply (bewp_rand_r true). do 2 bewp_pures_r.
          iApply "IH". by iApply "Hk".
        * do 6 bewp_pures_l.
          { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
          iApply bewp_rand_l. iIntros (b). destruct b.
          -- do 2 bewp_pures_l. iApply (bewp_rand_r true).
             do 6 bewp_pures_r.
             { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
             iApply (bewp_rand_r false).
             do 2 bewp_pures_r.
             iApply "IH". by iApply "Hk".
          -- do 2 bewp_pures_l. iApply (bewp_rand_r false). do 2 bewp_pures_r.
             iApply "IH". by iApply "Hk".
      ...
      + iDestruct "HND" as "[%e11 [%e12 [%e13 [%e21 [%e22 [%e23 HND]]]]]]".
        ...
        * do 6 bewp_pures_l.
          { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
          iApply bewp_rand_l. iIntros (b). destruct b.
          -- do 2 bewp_pures_l. iApply (bewp_rand_r true). do 2 bewp_pures_r.
             iApply "IH". by iApply "Hk".
          -- do 2 bewp_pures_l. iApply (bewp_rand_r false).
             do 6 bewp_pures_r.
             { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
             iApply (bewp_rand_r true).
             do 2 bewp_pures_r.
             iApply "IH". by iApply "Hk".
        * bewp_pures_l. bewp_pures_l. iApply (bewp_rand_r false).
          do 6 bewp_pures_r.
          { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
          iApply (bewp_rand_r false). do 2 bewp_pures_r.
          iApply "IH". by iApply "Hk".
      ...
      + iDestruct "HND" as "[%e11 [-> #HQ]]".
        ...
        { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
        iApply bewp_rand_l. iIntros (b). destruct b.
        * bewp_pures_l. do 2 bewp_pure_l. { by apply neutral_ectx; set_solver. }
          do 8 bewp_pure_l.
          iLöb as "IH'". bewp_pure_l. by iApply "IH'".
        * do 2 bewp_pures_l. by iApply "IH"; iApply "Hk".
      ...
      + iDestruct "HND" as "[%e22 (Hlc & -> & #HQ)]".
        ...
        iModIntro. do 5 bewp_pures_r.
        { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
        iApply (bewp_rand_r false). bewp_pures_r. bewp_pures_r.
        iApply "IH". by iApply "Hk".
      ...
      + iDestruct "HND" as "[%e22 (Hlc & -> & #HQ)]".
        ...
        iModIntro. do 5 bewp_pures_r.
        { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
        iApply (bewp_rand_r true). bewp_pures_r. bewp_pures_r.
        iApply "IH". by iApply "Hk".
      ...
      + iDestruct "HND" as "[%e11 [%e12 [%e21 [%e22 (-> & -> & #HQ1 & #HQ2)]]]]".
        ...
        { rewrite ectx_labels_app not_elem_of_app; split; [apply neutral_ectx|]; set_solver. }
        iApply bewp_rand_l. iIntros (b). destruct b.
        * bewp_pures_l. bewp_pures_l. iApply (bewp_rand_r false). do 2 bewp_pures_r.
          iApply "IH". by iApply "Hk".
        * bewp_pures_l. bewp_pures_l. iApply (bewp_rand_r true). do 2 bewp_pures_r.
          iApply "IH". by iApply "Hk".
  Qed.
