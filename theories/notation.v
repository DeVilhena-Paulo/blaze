...
From blaze Require Export syntax.
...
Check (λ (n : Z),
  "f" (Do n inhabitant) (Do "" inhabitant)
).
*)
...
let: "y" := λ: "z", "z" #() in
effect "get"
handle: (do: "get" inhabitant) with
| effect "get" "x", rec "k" as multi => "x"
| return "y" => "y"
end)%E.
